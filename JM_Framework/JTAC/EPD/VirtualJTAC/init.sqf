call compile preprocessFileLineNumbers "JM_Framework\JTAC\EPD\VirtualJTAC\jtacsettings.sqf";
call compile preprocessFileLineNumbers "JM_Framework\JTAC\EPD\VirtualJTAC\Attacks\Projectiles.sqf";
call compile preprocessFileLineNumbers "JM_Framework\JTAC\EPD\VirtualJTAC\Attacks\EvenSpread.sqf";
call compile preprocessFileLineNumbers "JM_Framework\JTAC\EPD\VirtualJTAC\Attacks\Mines.sqf";
call compile preprocessFileLineNumbers "JM_Framework\JTAC\EPD\VirtualJTAC\Attacks\Bombs.sqf";
call compile preprocessFileLineNumbers "JM_Framework\JTAC\EPD\VirtualJTAC\Attacks\Rockets.sqf";
call compile preprocessFileLineNumbers "JM_Framework\JTAC\EPD\VirtualJTAC\Attacks\GuidedMissile.sqf";
call compile preprocessFileLineNumbers "JM_Framework\JTAC\EPD\VirtualJTAC\Attacks\StrafingRun.sqf";
call compile preprocessFileLineNumbers "JM_Framework\JTAC\EPD\VirtualJTAC\jtacattackparser.sqf";
call compile preprocessFileLineNumbers "JM_Framework\JTAC\EPD\VirtualJTAC\jtacfirecontrol.sqf";
call compile preprocessFileLineNumbers "JM_Framework\JTAC\EPD\VirtualJTAC\jtacreload.sqf";
call compile preprocessFileLineNumbers "JM_Framework\JTAC\EPD\VirtualJTAC\jtacmapcontrol.sqf";
