...
_westsquadRP1 = ["westsquad_rp1","Deploy Squad RP","z\ace\addons\flags\data\icons\carry\white_carry_icon.paa",
{
	...
	if(count _num >2) then
		{
			...
			[10,[],{MF_Srp1 setVehiclePosition [(player modelToWorld[0,2,0]), [],0.5, "CAN_COLLIDE"]; hint "Rally Point Deployed"},{hint "Deploying interupted"},"Deploying Rally point"] call ace_common_fnc_progressBar
		} 
	else 
		{
