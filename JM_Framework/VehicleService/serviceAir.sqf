// Script to rearm, refuel and repair AIR vehicles
...
3. Place following into Activation:
		...
		call{_handle = [(thisList select 0)] execVM "JM_Framework\VehicleService\ServiceAir.sqf";}
...
if ((_veh isKindOf "air") && (currentPilot _veh == player)) exitWith {
